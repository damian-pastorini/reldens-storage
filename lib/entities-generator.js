...
const { KyselyDataServer } = require('./kysely/kysely-data-server');
const { DrizzleDataServer } = require('./drizzle/drizzle-data-server');
...
class EntitiesGenerator
{
    ...
    constructor(props)
    {
        ...
        this.templates = {
            ...
            'knex': FileHandler.joinPaths(this.templatesFolderPath, 'query-builder-model.template'),
            'kysely': FileHandler.joinPaths(this.templatesFolderPath, 'query-builder-model.template'),
            'drizzle': FileHandler.joinPaths(this.templatesFolderPath, 'drizzle-model.template'),
        ...
        this.driverModulesProps = {
            'objection-js': 'objectionModules',
            'mikro-orm': 'mikroOrmModules',
            'prisma': 'prismaModules',
            'knex': 'knexModules',
            'kysely': 'kyselyModules',
            'drizzle': 'drizzleModules'
        };
        ...
        this.modelsGeneration = new ModelsGeneration({
            ...
            templates: {
                ...
                'knex': this.templates['knex'],
                'kysely': this.templates['kysely'],
                'drizzle': this.templates['drizzle']
            }
        });
    ...
    async generate()
    {
        ...
        this.modelsGeneration.relationsDetection.allTablesData = tables;
    ...
    createServer()
    {
        ...
        let driverKey = sc.get(this.connectionData, 'driver', 'knex');
        ...
        let modulesProp = sc.get(this.driverModulesProps, driverKey, false);
        if(modulesProp && this[modulesProp]){
            serverConfig[modulesProp] = this[modulesProp];
        }
